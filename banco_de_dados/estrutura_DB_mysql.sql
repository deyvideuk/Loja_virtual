...
--
-- Host: 127.0.0.1    Database: toymania
-- ------------------------------------------------------
...
CREATE TABLE `usuarios` (
  ...
  `dataUsuario` varchar(12) NOT NULL,
  `cepUsuario` varchar(10) NOT NULL,
  `numeroUsuario` varchar(6) NOT NULL,
  `enderecoUsuario` varchar(50) NOT NULL,
  `complementoUsuario` varchar(20) NOT NULL,
  `bairroUsuario` varchar(20) NOT NULL,
